...
public class VideosAdapter extends BaseAdapter {
    ...
    private ArrayList<VideoInfo> mVideosList;

    public VideosAdapter(SendData sendData, Activity activity, ArrayList<VideoInfo> videosList) {
        mActivity = activity;
    ...
    public View getView(final int position, final View convertView, final ViewGroup parent) {
        ...
        VideoInfo info = mVideosList.get(position);
        holder.listButton.setText(info.getTitle());
        holder.imageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mSendData.sendData2NewScreen(mVideosList.get(position));
            }
        });
...
//                    holder.imageButton.setImageDrawable(placeHolderDrawable);
    ...
    public interface SendData {
        void sendData2NewScreen(VideoInfo videoInfo);
    }
}
